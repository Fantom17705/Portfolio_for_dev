$(function() {
    $('.fairy-tail__slider').slick({
        prevArrow: '<button type="button" class="slick-btn slick-prev"><img src="images\arrow-prev.svg" alt="preview"></button>',
    ...
    $('.our-trip__slider').slick({
        ...
        nextArrow: '<button type="button" class="slick-btn slick-next"><img src="images\Vector.svg" alt="next"></button>',
        autoplay: true,
        fade: true, 
    });
